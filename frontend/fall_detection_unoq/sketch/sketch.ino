...
void show_status(int code) {
  switch (code) {
    case 0: Monitor.println("STATUS | NORMAL"); break;
    case 1: Monitor.println("STATUS | FALL ALERT"); break;
    case 2: Monitor.println("STATUS | GAS WARNING"); break;
    case 3: Monitor.println("STATUS | HEAT WARNING"); break;
    case 4: Monitor.println("STATUS | FIRE RISK"); break;
    case 5: Monitor.println("STATUS | CRITICAL EMERGENCY"); break;
    default: Monitor.println("STATUS | ?"); break;
  }
}
